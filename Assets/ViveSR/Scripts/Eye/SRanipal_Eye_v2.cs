    ...
    namespace anipal
    {
        namespace Eye
        {
            public static class SRanipal_Eye_v2
            {
                ...
                public static bool GetPupilSize(EyeIndex eye, out float size, EyeData_v2 eye_data)
                {
                    bool valid = false;
                    if (SRanipal_Eye_Framework.Status == SRanipal_Eye_Framework.FrameworkStatus.WORKING)
                    {
                        ...
                        size = valid ? eyeData.pupil_diameter_mm : 0;
                    }
                    else
                    {
                        size = 0;
                ...
                public static bool GetPupilSize(EyeIndex eye, out float size)
                {
                    UpdateData();
                    return GetPupilSize(eye, out size, EyeData_);
                }
